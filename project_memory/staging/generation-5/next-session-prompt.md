...
- **Mit Vorrang nach Order 6: DEC-0119 + FR-0095 + FR-0096** (Freigabe = Verständnis-Abgleich, keine Arbeitserlaubnis; ruhige Karte mit PM-Erklärung; Sammel-Freigabe für Scope; Fehler ohne Freigabe; keine 'weiter?'-Fragen in den PM-Texten -- grep in allen Kits). Der Nutzer spürt es täglich in synaipse.
