...
| [H211](docs/holes/H211.md) | BUG-0295 | OPEN | Ein DEC-Verweis in einem Python-Docstring einer ausgelieferten Kit-Datei wird von keinem Leser beurteilt, wenn die Anfuehrungszeichen-Paarung ihn verschluckt (2 von 190, gemessen) |
...
| [H215](docs/holes/H215.md) | BUG-0299 | OPEN | Der H196-Startleser folgt einem argv, das ein Name hält, aber nicht dem PROGRAMMWORT, das erst ein lokaler Name auflöst -- heute ohne Opfer |
| [H216](docs/holes/H216.md) | BUG-0300 | OPEN | Der Stopper-Leser des Beweis-Vokabular-Tests begründet seine Unterscheidung (kann nicht zurückkehren vs. endet irgendwo) mit einer Zählung, die kein roter Test hält |
| [H217](docs/holes/H217.md) | BUG-0301 | OPEN | Der Beweis-Vokabular-Leser entschuldigt eine ganze Spanne, sobald irgendwo vor dem nächsten Backtick eine berechnete Flagge (`--%s`) steht -- eine echte Auslassung daneben bleibt stumm |
| H218 | BUG-0303 | OPEN | Die Befreiung vom Architektenschritt fragt den TYP des Ursprungs, nicht den WERT -- ein BUG mit leerer Kriterienliste befreit, und eine Referenz, die nur an der WURZEL existiert, loest am Spawn auf (zweite Restklasse von H155/BUG-0237) |
| H219 | BUG-0304 | OPEN | H214-Rest: die Ein-Aufruf-Form 'Datei schreiben und ausführen' bleibt offen, wenn der Läufer hinter einem Präfixwort steht, die Datei per Umleitung in den Interpreter geht oder eine Substitution sie an eval reicht |
