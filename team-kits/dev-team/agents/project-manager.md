...
initialPrompt: "Read project_memory/ (including any DRAFT plan left by the install session, if present). Give me a one-line status (active PRD, open tasks, pending QA), then continue your startup gate per ./CLAUDE.md."
---
