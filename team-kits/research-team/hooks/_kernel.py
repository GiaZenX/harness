...
# WHAT A COMMAND LINE LOSES BEFORE ITS SHELL PARSES IT lives in `_compat` (`EATEN_IN_FLIGHT`,
# `eaten_in_flight`), the reader this repository's own gates borrow too (BUG-0161 / H69).
...
def _eaten_in_flight(data):
    """`_compat.eaten_in_flight` -- the door above asks it under this name."""
    return _compat.eaten_in_flight(data)
